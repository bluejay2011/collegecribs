...
<html lang="en">
    <head>
        <meta name="application-name" content="Collegecribs.com.ph">
        <meta name="msapplication-tooltip" content="Collegecribs.com.ph - Your go to site when looking for place to stay near colleges in Philippines">
        <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
        <meta http-equiv="X-UA-Compatible" content="chrome=1">
        <title>College Cribs - Your go to site when looking for place to stay near colleges in Philippines</title>
        <meta name="description" content="Welcome to College Cribs!, a search engine for condominiums, apartments, boarding house, room for rent, transient near colleges in the Philippines. Quickly find what you're searching for, get in touch with friends and stay informed with the latest news and information.">
        <meta name="keywords" content="college, college cribs, college cribs apartment, college cribs condominium, college cribs boarding house, college cribs room for rent, college cribs transient, college stay philippines">
        <meta name="Author" content="Stephanie Jose">
        <meta property="og:image" content="/img/logo-small.png" />
        <link rel="shortcut icon" type="image/ico" href="/img/logo-small.png">
        {{ Asset::styles() }}
        {{ Asset::scripts() }}
    ...
    <body>
        ...
        <div class='container header'>            
            <div class='row'>                
                <div class='span3'>
                    {{ Util::image_link("/", 'img/college-cribs-logo.png', 'College Cribs', array('id' => 'college-cribs-logo')); }}
                </div>
            ...
            <footer>          
                <div class='row'>
                    ...
                    <div class='span8 footer footer-right'>
                        <span id='footer-logo'>
                            {{ HTML::image('img/logo-small.png', 'College Cribs', array('id' => 'college-cribs-footer-logo')); }}
                        </span>
                        <br />
