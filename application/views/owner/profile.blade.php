		...
		<div class='row'>
			<div class='page-header span11'>	
				<div class='row'>
					...
					<div class='span6'>
						<h2 class='page-header-title'>{{$property['property_name']}}</h2>
						<span class='page-header-description'>					
							<textarea class='span9' placeholder='My Description'>{{$property['property_description']}}</textarea>					
						</span>
					</div>				
				</div>
			</div>			
				...
				{{ Form::hidden('id', $property['id']); }}
					<div class='span5'>						
						...
						<div class="control-group">
						    <label class="control-label" for="inputDorm">Min. Rent Amount in Php</label>
						    <div class="controls">
						    	{{ Form::text('min_rent', number_format($property['rent_min'],2) , array('id' => 'crib-min-rent', 'placeholder' => "10,000.00")); }}						      
						    </div>
						</div>											
						<div class="control-group">
						    <label class="control-label" for="inputDorm">Max. Rent Amount in Php</label>
						    <div class="controls">
			...
			<div class='my-crib-gallery span12'>
				...
				<div class='span11'>
					@foreach($property_images as $images)
						<img class='crib-pics' src='<?php echo "{$root}/{$images->attributes['property_id']}/{$images->attributes['name']}"; ?>' >				
					@endforeach
				</div>
				<br />
