			...
			<div class='span9'>
				<div class='row'> <!-- Left Side Starts here -->	
					<div class='span3'>				
						<div class='crib-profile'>										
							...
							<div class='crib-gallery' id="gallery" data-toggle="modal-gallery" data-target="#modal-gallery"><br />
								<a data-gallery="gallery" href="http://fakeimg.pl/350x250/?text=bigger-version" title="Eto yung bigger version ng thumbnail">
					...
					<div class='span5'>
						...
						<?php } ?>
						<span class='crib-profile-details map'><a href='#'>View Map</a>
					</div>
				</div>
				<br />
				<div class='row'>
